...
// do not require this treatment, but certain resources (e.g. cert authorities) are loaded on a per-connection
...
// removed upon subsequent reads of the same key.  Unfortunately, there are some
// exceptions to this (e.g. very infrequently read values, or intermediate pages
// within a paginated API), which necessitate periodic cleanup.
