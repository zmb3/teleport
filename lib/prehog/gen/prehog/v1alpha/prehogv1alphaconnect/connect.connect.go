...
type ConnectReportingServiceClient interface {
	SubmitConnectEvent(context.Context, *connect_go.Request[v1alpha.ConnectSubmitEventRequest]) (*connect_go.Response[v1alpha.ConnectSubmitEventResponse], error)
}
...
func NewConnectReportingServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) ConnectReportingServiceClient {
	...
	return &connectReportingServiceClient{
		submitConnectEvent: connect_go.NewClient[v1alpha.ConnectSubmitEventRequest, v1alpha.ConnectSubmitEventResponse](
			httpClient,
...
type connectReportingServiceClient struct {
	submitConnectEvent *connect_go.Client[v1alpha.ConnectSubmitEventRequest, v1alpha.ConnectSubmitEventResponse]
}

// SubmitConnectEvent calls prehog.v1alpha.ConnectReportingService.SubmitConnectEvent.
func (c *connectReportingServiceClient) SubmitConnectEvent(ctx context.Context, req *connect_go.Request[v1alpha.ConnectSubmitEventRequest]) (*connect_go.Response[v1alpha.ConnectSubmitEventResponse], error) {
...
func (UnimplementedConnectReportingServiceHandler) SubmitConnectEvent(context.Context, *connect_go.Request[v1alpha.ConnectSubmitEventRequest]) (*connect_go.Response[v1alpha.ConnectSubmitEventResponse], error) {
