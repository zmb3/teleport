 ...
 * @const
 */
proto.teleport.terminal.v1.Database.repeatedFields_ = [10];
...
proto.teleport.terminal.v1.Database.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    addr: jspb.Message.getFieldWithDefault(msg, 9, ""),
 ...
 * @return {string}
 */
proto.teleport.terminal.v1.Database.prototype.getUriKind = function() {
 ...
 * @return {!proto.teleport.terminal.v1.Database} returns this
 */
proto.teleport.terminal.v1.Database.prototype.setUriKind = function(value) {
...
proto.teleport.terminal.v1.Database.prototype.getLabelsList = function() {
  return /** @type{!Array<!proto.teleport.terminal.v1.Label>} */ (
    jspb.Message.getRepeatedWrapperField(this, v1_label_pb.Label, 10));
};
...
proto.teleport.terminal.v1.Database.prototype.addLabels = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 10, opt_value, proto.teleport.terminal.v1.Label, opt_index);
};
