...
type ClusterClientEvent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//	*ClusterClientEvent_LoginSuccess
	Event isClusterClientEvent_Event `protobuf_oneof:"event"`
}

func (x *ClusterClientEvent) Reset() {
	*x = ClusterClientEvent{}
	if protoimpl.UnsafeEnabled {
...
func (x *ClusterClientEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClusterClientEvent) ProtoMessage() {}

func (x *ClusterClientEvent) ProtoReflect() protoreflect.Message {
	mi := &file_v1_service_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClusterClientEvent.ProtoReflect.Descriptor instead.
func (*ClusterClientEvent) Descriptor() ([]byte, []int) {
	return file_v1_service_proto_rawDescGZIP(), []int{24}
}

func (x *ClusterClientEvent) GetClusterUri() string {
	if x != nil {
		return x.ClusterUri
	}
	return ""
...
func (m *ClusterClientEvent) GetEvent() isClusterClientEvent_Event {
	if m != nil {
		return m.Event
	}
	return nil
...
func (x *ClusterClientEvent) GetLoginSuccess() *LoginSuccess {
	if x, ok := x.GetEvent().(*ClusterClientEvent_LoginSuccess); ok {
		return x.LoginSuccess
	}
	return nil
}

type isClusterClientEvent_Event interface {
	isClusterClientEvent_Event()
}

type ClusterClientEvent_LoginSuccess struct {
	LoginSuccess *LoginSuccess `protobuf:"bytes,2,opt,name=login_success,json=loginSuccess,proto3,oneof"`
}

func (*ClusterClientEvent_LoginSuccess) isClusterClientEvent_Event() {}

type ClusterServerEvent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	ClusterUri string `protobuf:"bytes,1,opt,name=cluster_uri,json=clusterUri,proto3" json:"cluster_uri,omitempty"`
	// Types that are assignable to Event:
	//	*ClusterServerEvent_CertExpired
	Event isClusterServerEvent_Event `protobuf_oneof:"event"`
}

func (x *ClusterServerEvent) Reset() {
	*x = ClusterServerEvent{}
	if protoimpl.UnsafeEnabled {
...
func (x *ClusterServerEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClusterServerEvent) ProtoMessage() {}

func (x *ClusterServerEvent) ProtoReflect() protoreflect.Message {
	mi := &file_v1_service_proto_msgTypes[25]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClusterServerEvent.ProtoReflect.Descriptor instead.
func (*ClusterServerEvent) Descriptor() ([]byte, []int) {
	return file_v1_service_proto_rawDescGZIP(), []int{25}
}

func (x *ClusterServerEvent) GetClusterUri() string {
	if x != nil {
		return x.ClusterUri
	}
	return ""
...
func (m *ClusterServerEvent) GetEvent() isClusterServerEvent_Event {
	if m != nil {
		return m.Event
	}
	return nil
...
func (x *ClusterServerEvent) GetCertExpired() *CertExpired {
	if x, ok := x.GetEvent().(*ClusterServerEvent_CertExpired); ok {
		return x.CertExpired
	}
	return nil
}

type isClusterServerEvent_Event interface {
	isClusterServerEvent_Event()
}

type ClusterServerEvent_CertExpired struct {
	CertExpired *CertExpired `protobuf:"bytes,2,opt,name=cert_expired,json=certExpired,proto3,oneof"`
}

func (*ClusterServerEvent_CertExpired) isClusterServerEvent_Event() {}
...
var file_v1_service_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x22, 0x89, 0x01, 0x0a, 0x12, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43,
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x6c,
	0x75, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x75, 0x72, 0x69, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0a, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x55, 0x72, 0x69, 0x12, 0x49, 0x0a, 0x0d, 0x6c,
	0x6f, 0x67, 0x69, 0x6e, 0x5f, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x22, 0x2e, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x74, 0x65,
	0x72, 0x6d, 0x69, 0x6e, 0x61, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x53,
	...
	,
	...
	0x12, 0x67, 0x0a, 0x0d, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x1a, 0x28, 0x2e, 0x74, 0x65,
	0x6c, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x61, 0x6c, 0x2e,
	0x76, 0x31, 0x2e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
...
var file_v1_service_proto_goTypes = []interface{}{
	...
	(*ClusterClientEvent)(nil),        // 24: teleport.terminal.v1.ClusterClientEvent
	(*ClusterServerEvent)(nil),        // 25: teleport.terminal.v1.ClusterServerEvent
	(*LoginSuccess)(nil),              // 26: teleport.terminal.v1.LoginSuccess
	(*CertExpired)(nil),               // 27: teleport.terminal.v1.CertExpired
	(*LoginRequest_LocalParams)(nil),  // 28: teleport.terminal.v1.LoginRequest.LocalParams
	(*LoginRequest_SsoParams)(nil),    // 29: teleport.terminal.v1.LoginRequest.SsoParams
...
var file_v1_service_proto_depIdxs = []int32{
	28, // 0: teleport.terminal.v1.LoginRequest.local:type_name -> teleport.terminal.v1.LoginRequest.LocalParams
	29, // 1: teleport.terminal.v1.LoginRequest.sso:type_name -> teleport.terminal.v1.LoginRequest.SsoParams
	30, // 2: teleport.terminal.v1.ListClustersResponse.clusters:type_name -> teleport.terminal.v1.Cluster
	31, // 3: teleport.terminal.v1.ListDatabasesResponse.databases:type_name -> teleport.terminal.v1.Database
	32, // 4: teleport.terminal.v1.ListGatewaysResponse.gateways:type_name -> teleport.terminal.v1.Gateway
	33, // 5: teleport.terminal.v1.ListServersResponse.servers:type_name -> teleport.terminal.v1.Server
	34, // 6: teleport.terminal.v1.ListKubesResponse.kubes:type_name -> teleport.terminal.v1.Kube
	35, // 7: teleport.terminal.v1.ListAppsResponse.apps:type_name -> teleport.terminal.v1.App
	26, // 8: teleport.terminal.v1.ClusterClientEvent.login_success:type_name -> teleport.terminal.v1.LoginSuccess
	27, // 9: teleport.terminal.v1.ClusterServerEvent.cert_expired:type_name -> teleport.terminal.v1.CertExpired
	7,  // 10: teleport.terminal.v1.TerminalService.ListRootClusters:input_type -> teleport.terminal.v1.ListClustersRequest
	10, // 11: teleport.terminal.v1.TerminalService.ListLeafClusters:input_type -> teleport.terminal.v1.ListLeafClustersRequest
	9,  // 12: teleport.terminal.v1.TerminalService.ListDatabases:input_type -> teleport.terminal.v1.ListDatabasesRequest
	12, // 13: teleport.terminal.v1.TerminalService.ListDatabaseUsers:input_type -> teleport.terminal.v1.ListDatabaseUsersRequest
	15, // 14: teleport.terminal.v1.TerminalService.ListGateways:input_type -> teleport.terminal.v1.ListGatewaysRequest
	18, // 15: teleport.terminal.v1.TerminalService.ListServers:input_type -> teleport.terminal.v1.ListServersRequest
	5,  // 16: teleport.terminal.v1.TerminalService.ListKubes:input_type -> teleport.terminal.v1.ListKubesRequest
	6,  // 17: teleport.terminal.v1.TerminalService.ListApps:input_type -> teleport.terminal.v1.ListAppsRequest
	14, // 18: teleport.terminal.v1.TerminalService.CreateGateway:input_type -> teleport.terminal.v1.CreateGatewayRequest
	4,  // 19: teleport.terminal.v1.TerminalService.AddCluster:input_type -> teleport.terminal.v1.AddClusterRequest
	0,  // 20: teleport.terminal.v1.TerminalService.RemoveCluster:input_type -> teleport.terminal.v1.RemoveClusterRequest
	17, // 21: teleport.terminal.v1.TerminalService.RemoveGateway:input_type -> teleport.terminal.v1.RemoveGatewayRequest
	22, // 22: teleport.terminal.v1.TerminalService.GetAuthSettings:input_type -> teleport.terminal.v1.GetAuthSettingsRequest
	...
	24, // 26: teleport.terminal.v1.TerminalService.ClusterEvents:input_type -> teleport.terminal.v1.ClusterClientEvent
	...
	16, // 31: teleport.terminal.v1.TerminalService.ListGateways:output_type -> teleport.terminal.v1.ListGatewaysResponse
	19, // 32: teleport.terminal.v1.TerminalService.ListServers:output_type -> teleport.terminal.v1.ListServersResponse
	20, // 33: teleport.terminal.v1.TerminalService.ListKubes:output_type -> teleport.terminal.v1.ListKubesResponse
	21, // 34: teleport.terminal.v1.TerminalService.ListApps:output_type -> teleport.terminal.v1.ListAppsResponse
	...
	23, // 37: teleport.terminal.v1.TerminalService.RemoveCluster:output_type -> teleport.terminal.v1.EmptyResponse
	23, // 38: teleport.terminal.v1.TerminalService.RemoveGateway:output_type -> teleport.terminal.v1.EmptyResponse
	...
	23, // 41: teleport.terminal.v1.TerminalService.Login:output_type -> teleport.terminal.v1.EmptyResponse
	23, // 42: teleport.terminal.v1.TerminalService.Logout:output_type -> teleport.terminal.v1.EmptyResponse
	25, // 43: teleport.terminal.v1.TerminalService.ClusterEvents:output_type -> teleport.terminal.v1.ClusterServerEvent
...
func file_v1_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_service_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClusterClientEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_service_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClusterServerEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_v1_service_proto_msgTypes[24].OneofWrappers = []interface{}{
		(*ClusterClientEvent_LoginSuccess)(nil),
	}
	file_v1_service_proto_msgTypes[25].OneofWrappers = []interface{}{
		(*ClusterServerEvent_CertExpired)(nil),
	}
	type x struct{}
...
type TerminalServiceClient interface {
	...
	ClusterEvents(ctx context.Context, opts ...grpc.CallOption) (TerminalService_ClusterEventsClient, error)
}
...
func (c *terminalServiceClient) ClusterEvents(ctx context.Context, opts ...grpc.CallOption) (TerminalService_ClusterEventsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_TerminalService_serviceDesc.Streams[0], "/teleport.terminal.v1.TerminalService/ClusterEvents", opts...)
	if err != nil {
		return nil, err
	}
...
type TerminalService_ClusterEventsClient interface {
	Send(*ClusterClientEvent) error
	Recv() (*ClusterServerEvent, error)
	grpc.ClientStream
}
...
func (x *terminalServiceClusterEventsClient) Send(m *ClusterClientEvent) error {
	return x.ClientStream.SendMsg(m)
}

func (x *terminalServiceClusterEventsClient) Recv() (*ClusterServerEvent, error) {
	m := new(ClusterServerEvent)
...
type TerminalServiceServer interface {
	...
	ClusterEvents(TerminalService_ClusterEventsServer) error
}
...
func (*UnimplementedTerminalServiceServer) ClusterEvents(TerminalService_ClusterEventsServer) error {
...
func _TerminalService_ClusterEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TerminalServiceServer).ClusterEvents(&terminalServiceClusterEventsServer{stream})
}

type TerminalService_ClusterEventsServer interface {
	Send(*ClusterServerEvent) error
	Recv() (*ClusterClientEvent, error)
	grpc.ServerStream
}
...
func (x *terminalServiceClusterEventsServer) Send(m *ClusterServerEvent) error {
	return x.ServerStream.SendMsg(m)
}

func (x *terminalServiceClusterEventsServer) Recv() (*ClusterClientEvent, error) {
	m := new(ClusterClientEvent)
