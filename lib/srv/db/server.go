...
import (
	...
	_ "github.com/zmb3/teleport/lib/srv/db/cassandra"
	"github.com/zmb3/teleport/lib/srv/db/cloud"
	"github.com/zmb3/teleport/lib/srv/db/cloud/users"
	"github.com/zmb3/teleport/lib/srv/db/common"
	// Import to register Elasticsearch engine.
	_ "github.com/zmb3/teleport/lib/srv/db/elasticsearch"
	// Import to register MongoDB engine.
	_ "github.com/zmb3/teleport/lib/srv/db/mongodb"
	"github.com/zmb3/teleport/lib/srv/db/mysql"
	// Import to register Postgres engine.
	_ "github.com/zmb3/teleport/lib/srv/db/postgres"
	// Import to register Redis engine.
	_ "github.com/zmb3/teleport/lib/srv/db/redis"
	// Import to register Snowflake engine.
	_ "github.com/zmb3/teleport/lib/srv/db/snowflake"
