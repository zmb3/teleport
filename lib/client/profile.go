...
func ReadProfileStatus(ks KeyStore, profileName string) (*ProfileStatus, error) {
	var err error
	if profileName == "" {
...
func FullProfileStatus(ks KeyStore) (*ProfileStatus, []*ProfileStatus, error) {
