...
func KeyFromIdentityFile(idFn string) (key *Key, err error) {
	ident, err := client.ReadIdentityFile(idFn)
	if err != nil {
...
func (k *Key) AsAgentKeys() ([]agent.AddedKey, error) {
	return apiutils.AsAgentKeys(k.Cert, k.Priv)
}
...
func (k *Key) HostKeyCallback() (ssh.HostKeyCallback, error) {
	return apiutils.HostKeyCallback(k.SSHCAs())
}
