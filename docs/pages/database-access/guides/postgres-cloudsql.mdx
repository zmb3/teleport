...
You will use the instance's private or public IP address to connect to it. The Teleport Database service has to
connect to that address and port that may require additional networking settings if run on a separate network.
IP Addresses can be viewed on the "Connect to this instance" panel on the Overview page:

![Instance Public IP](../../../img/database-access/guides/cloudsql/instance-private-ip@2x.png)
...
db_service:
  ...
  - name: "cloudsql"
    ...
    # Database protocol.
    protocol: "postgres"
    # Database endpoint. For Cloud SQL use instance's private or public IP address.
    uri: "35.1.2.3:5432"
