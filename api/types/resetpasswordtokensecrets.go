...
// UnmarshalResetPasswordTokenSecrets unmarshals ResetPasswordTokenSecrets from JSON or YAML.
...
// MarshalResetPasswordTokenSecrets marshals ResetPasswordTokenSecrets to JSON or YAML.
